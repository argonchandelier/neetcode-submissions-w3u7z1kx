...
class Solution:
    def reorderList(self, head: Optional[ListNode]) -> None:
        ...
        #prevF.next = prevB
        print(prevF, prevB, prevF.val, prevB.val)
        print(prevF.next.val)
        #prevB.next = prevF
        
        #backward.next.next.next = mid
        #print(prevB.val, prevB.next, prevB.next.val, prevB.next.next.val, prevB.next.next.next.val)
