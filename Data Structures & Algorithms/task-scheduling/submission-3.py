...
class Solution:
    ...
    def solve(self, vals, np):
        ...
        print(f"m4xn4: {m4}x{n4}; m5xn2: {m5}x{n2}; m1xn1: {m1}x{n1};  {ia= }, {ib= }, {ic= };  {curWi1= }, {curWi2= };  {sp= }, {T= }")
        C = 0
        print(f"\nStarting loop...")
        #while True:
        for _ in range(100):
            ...
            if c == cf and ia == 0:
                ...
                print(f"\nEnding...\n{finalAdd1 = }, {finalAdd2 = }, (ib == l: {ib == l}), final C (answer): {C}")
                #break
                return nTasks
            if cr < cl or (cl == cr and spct > n2*(m5-1)):
                ...
                print(
                    f"join with RIGHT: m4xn4: {m4}x{n4}; m5xn2: {m5}x{n2}; m1xn1: {m1}x{n1};  {ia= }, {ib= }, {ic= };  {curWi1= }, {curWi2= };  {sp= }, {T= }")
            if cl <= cr:
                T = (spct % n2) + n4
                ia -= n4
                curWi1 -= 1
                n2 += n4
                #n4 = n2+w[curWi1-1] if curWi1 > 0 else 0
                ...
                m5 = m2-m4
                print(
                    f"join with LEFT: m4xn4: {m4}x{n4}; m5xn2: {m5}x{n2}; m1xn1: {m1}x{n1};  {ia= }, {ib= }, {ic= };  {curWi1= }, {curWi2= };  {sp= }, {T= }")
